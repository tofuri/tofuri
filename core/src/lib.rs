...
pub const RATELIMIT_BLOCK: usize = 99;
pub const RATELIMIT_TRANSACTION: usize = 99;
pub const RATELIMIT_STAKE: usize = 99;
pub const RATELIMIT_MULTIADDR: usize = 1;
pub const RATELIMIT_SYNC_REQUEST: usize = 1;
pub const RATELIMIT_SYNC_RESPONSE: usize = 1;
pub const RATELIMIT_DURATION: u32 = 60;
