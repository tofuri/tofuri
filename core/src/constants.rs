...
pub const DECIMAL_PRECISION: u128 = 10u128.pow(18);
...
pub const BLOCK_TIME_MIN: usize = 1; // 60
pub const BLOCK_TIME_MAX: usize = 2; // 90
pub const EXTENSION: &str = "pea";
pub const AMOUNT_BYTES: usize = 4;
pub const PENDING_BLOCKS_LIMIT: usize = 10;
pub const TRUST_FORK_AFTER_BLOCKS: usize = 1440;
pub const TPS: usize = 5;
