...
pub const P2P_REQUEST_RESPONSE: usize = 60 + 1;
pub const P2P_BLOCKS: usize = 1 + 1;
pub const P2P_TRANSACTIONS: usize = 60 * 100;
pub const P2P_STAKES: usize = 60 * 100;
pub const P2P_PEERS: usize = 1 + 1;
