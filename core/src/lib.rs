...
pub const RATELIMIT_TOPIC_BLOCK: usize = 2;
pub const RATELIMIT_TOPIC_BLOCKS: usize = 4;
pub const RATELIMIT_TOPIC_TRANSACTION: usize = 8;
pub const RATELIMIT_TOPIC_STAKE: usize = 8;
pub const RATELIMIT_TOPIC_MULTIADDR: usize = 2;
